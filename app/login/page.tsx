        ...
        <section className='w-full flex justify-center items-center h-screen'>
            ...
            <nav className='fixed top-0 left-0 w-full flex justify-between items-center px-5 py-5'>
                ...
                <div className="flex items-center space-x-5 mr-5">
                    <Link href={"/login"} className="px-8 py-3 rounded-full bg-sky-500 text-sm">Login</Link>
                    <Link href={"/signup"} className="text-sm hover:underline">Signup</Link>
                </div>
            </nav>
            <div>
                <form className='borde py-7 px-5 w-72  space-y-7 rounded-lg'>
                    <h1 className='text-center text-2xl text-sky-500'>Log in</h1>
                    <div className='space-y-4'>
                        ...
                        <div className="flex items-center justify-center space-x-2 ml-1">
                            ...
                            <Link href={'/signup'} className='underline block text-xs text-gray-800'>forgot password?</Link>
                        </div>
