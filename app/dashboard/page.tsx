...
const page = (props: Props) => {
    return (
        <section>
            <aside className='fixed top-0 left-0 bg-white border-r border-gray-300 h-full w-16 flex flex-col justify-between pb-10'>
                <div className='h-full w-full py-5 space-y-7'>
                    <Link href={"/"} className='flex flex-col justify-center items-center text-green-500'>
